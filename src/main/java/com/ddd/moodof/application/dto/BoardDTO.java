...
public class BoardDTO {
    ...
    public static class CreateBoard {
        ...
        public Board setSharedKey(Board board){
            return new Board(board.getId(),board.getPreviousBoardId(),board.getUserId(), board.getName(),board.getCategoryId(), board.getSharedURL(),board.getSharedKey(), board.getCreatedDate(), board.getLastModifiedDate());
        }
